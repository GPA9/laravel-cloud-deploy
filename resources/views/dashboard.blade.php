    ...
    <div class="flex h-full w-full flex-1 flex-col gap-6 p-4">
        ...
        <div class="grid gap-6 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
            @foreach($characters as $character)
                <div class="relative overflow-hidden rounded-xl border border-neutral-200 dark:border-neutral-700 shadow hover:shadow-lg transition">
                    <img 
                        src="https://thesimpsonsapi.com{{ $character->portrait_path }}" 
                        alt="{{ $character->name }}" 
        ...
        @if($characters->isEmpty())
            <p class="text-center text-gray-500 dark:text-gray-400 mt-8">
                ...
                <a href="{{ url('api/characters/import') }}" class="text-blue-500 hover:underline">Importa personajes</a>
            </p>
        @endif
    </div>
</x-layouts.app>
